...
Module: Gossip Protocol – Showcase Simulation
---------------------------------------------

Simulates basic Gossip protocol on a random network topology using NetworkX.
...
Related:
    - gossip_stats.py: Statistical multi-seed evaluation
...
# ===============================
# protocol_eval/showcase/gossip_showcase.py
# or stats/gossip_stats.py
# ===============================
...
from protocols import gossip   # <- change per protocol

# -------------------------------
# Config
# -------------------------------
PROTOCOL_NAME = "Gossip"
...
def main():
    ...
    for run in range(RUNS):
        ...
        history, deliveries = simulator.run(
            G, protocol=gossip.protocol, seeds=seeds, ticks=SIM_TICKS
        )
